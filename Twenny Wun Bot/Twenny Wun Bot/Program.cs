    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (token2 == null)
            {
                ...
                var applicationCredentials = CredentialsCreator.GenerateApplicationCredentials("API key", "API secret");
            ...
            else
            {
                try
                {
                    ...
                    TwitterCredentials.SetCredentials(token1, token2, "API key", "API secret");
                }
                catch (Exception)
                {
